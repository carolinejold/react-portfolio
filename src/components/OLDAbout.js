      ...
      <Fade bottom>
        <div className="about-container2">
          ...
          <div className="about-code">
            ...
            <p>
              JavaScript | React | HTML5 | CSS3 | REST | HTTP/JSON/AJAX | Git |
              jQuery | Gatsby | Netlify | Express | Node.js | MongoDB | Redux |
              Styled Components | VSCode | Mocha/Jest | TDD | Mob Programming |
              Agile, Scrum & Remote Work Methods | Native English Speaker
            </p>
            <p>
          ...
          <div className="about-quotes">
            ...
            <p>
              <i>
                ...
                in which she makes a new concept or framework seem like her
                native tongue'
              </i>
            </p>
          </div>
